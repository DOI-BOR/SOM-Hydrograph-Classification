...
if __name__ == "__main__":
    ...
    writer = pd.ExcelWriter('hydro_extraction_results/hydro_extraction_results.xlsx')
    ...
    for i in u_labels:
        ...
        som_cluster_df = pd.DataFrame(columns = d_indices[0:len(d_indices) - 1])
        #Iterates trhough every cell in the cluster and calculates metrics based on weight
        j = 0
        for w in weightList:
